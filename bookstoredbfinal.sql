/*
 ...
 Source Server         : bookstoredb
 Source Server Type    : MySQL
 Source Server Version : 80035 (8.0.35)
 Source Host           : bookstoredb.cri6y6i4wac4.ap-southeast-2.rds.amazonaws.com:3306
...
CREATE TABLE `author`  (
  ...
  `author_code` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
...
-- Records of author
-- ----------------------------
INSERT INTO `author` VALUES (16, 'Nguyễn Nhật Ánh', 'nguyen-nhat-anh', '2023-04-09', '2023-04-19');
INSERT INTO `author` VALUES (18, 'Fujiko F. Fujio', 'fujiko-fujio', '2023-04-08', '2023-04-19');
INSERT INTO `author` VALUES (19, 'Gosho Aoyama', 'gosho-aoyama', '2023-04-09', NULL);
INSERT INTO `author` VALUES (22, 'Antoine De Saint-Exupéry', 'antoine-de-saint', '2023-04-22', '2023-04-22');
INSERT INTO `author` VALUES (24, 'Minette Walters', 'minette-walters', '2023-04-25', '2023-04-29');
INSERT INTO `author` VALUES (25, 'Luis Sepulveda', 'luis-sepulveda', '2023-04-25', NULL);
INSERT INTO `author` VALUES (26, 'R. J. Palacio', 'palacio', '2023-04-25', NULL);
INSERT INTO `author` VALUES (30, 'Eran Katz', 'eran-katz', '2023-05-05', NULL);
INSERT INTO `author` VALUES (31, 'Luật sư Nguyễn Ngọc Bích', 'nguyen-ngoc-bich', '2023-05-05', NULL);
INSERT INTO `author` VALUES (32, ' Luật sư Trương Hữu Ngữ', 'truong-huu-ngu', '2023-05-05', NULL);
INSERT INTO `author` VALUES (33, 'Bộ Giáo Dục Và Đào Tạo', 'bo-giao-duc', '2023-05-05', NULL);
INSERT INTO `author` VALUES (34, 'Phạm Anh Đức', 'pham-anh-duc', '2023-05-05', NULL);
INSERT INTO `author` VALUES (35, 'Paul Kennedy', 'paul-kennedy', '2023-05-05', NULL);
INSERT INTO `author` VALUES (36, 'Nhiều tác giả', 'nhieu-tac-gia', '2023-05-05', NULL);
INSERT INTO `author` VALUES (37, 'Đồng Lạc', 'dong-lac', '2023-05-05', NULL);
INSERT INTO `author` VALUES (38, 'Rosie Nguyễn', 'rosie-nguyen', '2023-05-05', NULL);
INSERT INTO `author` VALUES (39, 'Hattie Hamilton', 'hattie-hamilton', '2023-05-05', NULL);
INSERT INTO `author` VALUES (40, ' Luis Sepulveda', ' luis-sepulveda', '2023-05-05', NULL);
INSERT INTO `author` VALUES (41, 'Gotouge Koyoharu', 'gotouge-koyoharu', '2023-05-23', NULL);
...
CREATE TABLE `book`  (
  ...
  `year_public` int NULL DEFAULT NULL,
  `total_page` int NULL DEFAULT NULL,
  `categoryID` int NOT NULL,
  `authorID` int NOT NULL,
  `publisher` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `bookimage`  (
  ...
  CONSTRAINT `bookimage_ibfk_1` FOREIGN KEY (`bookID`) REFERENCES `book` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bookimage
-- ----------------------------
INSERT INTO `bookimage` VALUES (9, 'admin/img/bookupload/doremon-13.jpg', 22);
INSERT INTO `bookimage` VALUES (10, 'admin/img/bookupload/conan-khuc-nhac-cau-sieu.jpg', 3);
INSERT INTO `bookimage` VALUES (11, 'admin/img/bookupload/conan-special-1.jpg', 4);
INSERT INTO `bookimage` VALUES (12, 'https://salt.tikicdn.com/cache/w1200/ts/product/f9/da/51/7dbe44bde10b54b69b4e86b99fee05b5.jpg', 20);
INSERT INTO `bookimage` VALUES (13, 'admin/img/bookupload/conan-80.jpg', 6);
INSERT INTO `bookimage` VALUES (14, 'admin/img/bookupload/doremon-44.jpg', 21);
INSERT INTO `bookimage` VALUES (16, 'admin/img/bookupload/conan-1.jpg', 24);
INSERT INTO `bookimage` VALUES (22, 'admin/img/bookupload/conan-1a.jpg', 24);
INSERT INTO `bookimage` VALUES (23, 'admin/img/bookupload/nhung-nguoi-hang-xom.jpg', 26);
INSERT INTO `bookimage` VALUES (24, 'admin/img/bookupload/mat-biec.jpg', 27);
INSERT INTO `bookimage` VALUES (25, 'admin/img/bookupload/ngay-xua-co-mot-chuyen-tinh.jpg', 28);
INSERT INTO `bookimage` VALUES (26, 'admin/img/bookupload/ke-nan-sap.jpg', 29);
INSERT INTO `bookimage` VALUES (27, 'admin/img/bookupload/hoang-tu-be.jpg', 30);
INSERT INTO `bookimage` VALUES (28, 'admin/img/bookupload/the-story-of-a-seagull-and-the-cat.jpg', 31);
INSERT INTO `bookimage` VALUES (29, 'admin/img/bookupload/wonder.jpg', 32);
INSERT INTO `bookimage` VALUES (30, 'admin/img/bookupload/fairy-tales.jpg', 33);
INSERT INTO `bookimage` VALUES (35, 'admin/img/bookupload/doremon.jpg', 37);
INSERT INTO `bookimage` VALUES (42, 'admin/img/bookupload/tri-tue-do-thai.jpg', 39);
INSERT INTO `bookimage` VALUES (43, 'admin/img/bookupload/tu-duy-phap-ly.jpg', 40);
INSERT INTO `bookimage` VALUES (44, 'admin/img/bookupload/phap-ly-can-ban.jpg', 41);
INSERT INTO `bookimage` VALUES (45, 'admin/img/bookupload/triet.jpg', 42);
INSERT INTO `bookimage` VALUES (46, 'admin/img/bookupload/tu-tuong.jpg', 43);
INSERT INTO `bookimage` VALUES (47, 'admin/img/bookupload/kinh-te-dau-tu.jpg', 44);
INSERT INTO `bookimage` VALUES (48, 'admin/img/bookupload/cnxh.jpg', 45);
INSERT INTO `bookimage` VALUES (49, 'admin/img/bookupload/ktct.jpg', 46);
INSERT INTO `bookimage` VALUES (50, 'admin/img/bookupload/su-troi-day.jpg', 47);
INSERT INTO `bookimage` VALUES (51, 'admin/img/bookupload/dai-viet-su-ky-toan-thu.jpg', 48);
INSERT INTO `bookimage` VALUES (52, 'admin/img/bookupload/tran-trieu-nhan-thoai.jpg', 49);
INSERT INTO `bookimage` VALUES (53, 'admin/img/bookupload/tuoi-tre-dang-gia.jpg', 50);
INSERT INTO `bookimage` VALUES (54, 'admin/img/bookupload/cam-nang-sinh-ton.jpg', 51);
INSERT INTO `bookimage` VALUES (55, 'admin/img/bookupload/phat-trien-tri-tue.jpg', 52);
INSERT INTO `bookimage` VALUES (57, 'admin/img/bookupload/thanh-guom-diet-quy.jpg', 54);
INSERT INTO `bookimage` VALUES (58, 'admin/img/bookupload/hinh-anh-doremon.jpg', 22);
INSERT INTO `bookimage` VALUES (61, 'admin/img/bookupload/hinh-anh-doremon.jpg', 53);
INSERT INTO `bookimage` VALUES (64, 'https://drive.google.com/thumbnail?id=1dYvk3I2Mn2fCnAY54tsl8IhYjGbzm94Q', 58);
...
CREATE TABLE `cart`  (
  ...
  INDEX `fk_cart_user`(`userID` ASC) USING BTREE,
  INDEX `fk_cart_book`(`bookID` ASC) USING BTREE,
  CONSTRAINT `fk_cart_book` FOREIGN KEY (`bookID`) REFERENCES `book` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_cart_user` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, 'truyen-tranh', 'Truyện tranh', '2023-02-17', NULL);
INSERT INTO `category` VALUES (2, 'chinh-tri', 'Chính trị - Pháp lý', '2023-03-10', '2023-05-03');
INSERT INTO `category` VALUES (3, 'giao-khoa', 'Giáo khoa - Giáo trình', NULL, NULL);
INSERT INTO `category` VALUES (4, 'tieng-anh', 'Tiếng Anh', NULL, NULL);
INSERT INTO `category` VALUES (5, 'tam-ly', 'Tâm lý - Giới tính', NULL, '2023-05-03');
INSERT INTO `category` VALUES (6, 'lich-su', 'Lịch sử', NULL, NULL);
INSERT INTO `category` VALUES (7, 'khoa-hoc', 'Khoa học - Kỹ thuật', NULL, NULL);
INSERT INTO `category` VALUES (8, 'thieu-nhi', 'Thiếu nhi', '2023-03-02', '2023-05-05');
INSERT INTO `category` VALUES (9, 'kinh-doanh', 'Kinh doanh', NULL, NULL);
INSERT INTO `category` VALUES (10, 'van-hoc', 'Văn học', NULL, NULL);
INSERT INTO `category` VALUES (12, 'tieng-viet', 'Tiếng Việt', NULL, NULL);
INSERT INTO `category` VALUES (17, 'ky-nang', 'Kỹ năng sống', '2023-05-05', NULL);
INSERT INTO `category` VALUES (18, 'trinh-tham', 'Trinh thám', '2024-06-03', NULL);
...
CREATE TABLE `orderline`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `FKcyl1xgylw2sa0k3oqighqgd56`(`bookID` ASC) USING BTREE,
  INDEX `fk_order`(`orderID` ASC) USING BTREE,
  CONSTRAINT `fk_order` FOREIGN KEY (`orderID`) REFERENCES `orders` (`orderID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKcyl1xgylw2sa0k3oqighqgd56` FOREIGN KEY (`bookID`) REFERENCES `book` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FKdouy9nmjxe36by2xqq0t5pqxf` FOREIGN KEY (`orderID`) REFERENCES `orders` (`orderID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orderline
-- ----------------------------
INSERT INTO `orderline` VALUES (13, 1, 20000, 21, 11);
INSERT INTO `orderline` VALUES (14, 1, 18000, 24, 11);
INSERT INTO `orderline` VALUES (15, 1, 205000, 48, 12);
INSERT INTO `orderline` VALUES (16, 2, 162000, 45, 12);
INSERT INTO `orderline` VALUES (17, 1, 35000, 52, 13);
INSERT INTO `orderline` VALUES (18, 1, 76500, 51, 13);
INSERT INTO `orderline` VALUES (19, 1, 40500, 53, 13);
INSERT INTO `orderline` VALUES (20, 1, 68000, 46, 14);
INSERT INTO `orderline` VALUES (21, 1, 51000, 30, 15);
INSERT INTO `orderline` VALUES (22, 1, 120000, 41, 15);
INSERT INTO `orderline` VALUES (23, 1, 20000, 21, 16);
INSERT INTO `orderline` VALUES (24, 3, 60000, 20, 16);
INSERT INTO `orderline` VALUES (25, 1, 40500, 53, 17);
INSERT INTO `orderline` VALUES (26, 1, 35000, 52, 17);
INSERT INTO `orderline` VALUES (27, 1, 76500, 51, 17);
...
CREATE TABLE `orders`  (
  ...
  INDEX `FKpnm1eeupqm4tykds7k3okqegv`(`userID` ASC) USING BTREE,
  CONSTRAINT `FKpnm1eeupqm4tykds7k3okqegv` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (11, '36 Lê Hồng Phong', '2023-04-24', NULL, '', NULL, 'Đang xử lý..', 53000, NULL, 1);
INSERT INTO `orders` VALUES (12, '141/2 Đinh Tiên Hoàng, Q1, TP Hồ Chí Minh', '2023-05-06', NULL, 'Bọc hàng cẩn thận, giao giờ hành chính', NULL, 'Đang xử lý..', 382000, NULL, 4);
INSERT INTO `orders` VALUES (13, '81 Nguyễn Gia', '2023-05-06', NULL, '', NULL, 'Đang xử lý..', 167000, NULL, 4);
INSERT INTO `orders` VALUES (14, 'TP Hồ Chí Minh', '2023-05-06', NULL, '', NULL, 'Đang giao hàng', 83000, NULL, 2);
INSERT INTO `orders` VALUES (15, '36 Lê Hồng Phong', '2023-05-11', NULL, '', NULL, 'Đang xử lý..', 186000, NULL, 2);
INSERT INTO `orders` VALUES (16, 'HCM', '2023-06-08', NULL, 'abc', NULL, 'Đang xử lý..', 95000, NULL, 7);
INSERT INTO `orders` VALUES (17, '- Đà Nẵng: Tầng 7, Tòa Nhà PVcomBank, Số 02, Đường 30 Tháng 4, Hải Châu', '2024-06-23', NULL, 'giao nhanh ', NULL, 'Giao hàng thành công', 167000, NULL, 9);
...
CREATE TABLE `roleuser`  (
  ...
  CONSTRAINT `fk_role` FOREIGN KEY (`roleID`) REFERENCES `role` (`roleID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of roleuser
-- ----------------------------
INSERT INTO `roleuser` VALUES (3, 2);
INSERT INTO `roleuser` VALUES (1, 1);
INSERT INTO `roleuser` VALUES (1, 2);
INSERT INTO `roleuser` VALUES (4, 2);
INSERT INTO `roleuser` VALUES (6, 2);
INSERT INTO `roleuser` VALUES (7, 2);
INSERT INTO `roleuser` VALUES (8, 1);
INSERT INTO `roleuser` VALUES (9, 2);
INSERT INTO `roleuser` VALUES (2, 1);
...
CREATE TABLE `users`  (
  ...
  `fullname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
  `username` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `birthdate` date NULL DEFAULT NULL,
  `gender` bit(1) NULL DEFAULT NULL,
  `phone` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
  `password` varchar(70) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
  `status` bit(1) NULL DEFAULT NULL,
  `confirm_token` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
  `is_enable` bit(1) NULL DEFAULT NULL,
  `provider` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NULL DEFAULT NULL,
  `created_at` date NULL DEFAULT NULL,
  `updated_at` date NULL DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'abc@gmail.com', 'Nguyen Van A', 'cmhg', '2023-04-15', b'1', '0783456781', '$2a$10$nj5rhD4uv7foG1ixoNByUe3gUohnRkMp/rI5d9bCse/AoM3p0JKbe', b'1', '349251', b'1', NULL, NULL, '2023-05-04');
INSERT INTO `users` VALUES (2, 'abcd@gmail.com', 'Nguyễn Tí Tò', 'tito-nguyen', '2004-06-05', b'0', '0312312319', '$2a$10$MI3cVSVzotI9Q1hSSGRcwuDHseBwmNNgOFkCnlW2bwx2pri9REpOW', b'0', '337625', b'1', NULL, NULL, '2023-05-11');
INSERT INTO `users` VALUES (3, 'abcde@gmail.com', NULL, 'hyuny', NULL, b'0', NULL, '$2a$12$Dvd8rJCJcLjq1hLmTmlD7uCa.3gEnPxEe0FhvyR8GMcXrLQZqsYeu', b'1', '794103', b'1', NULL, NULL, NULL);
INSERT INTO `users` VALUES (4, 'hacao412@gmail.com', 'Nguyễn Tí', 'chuotcon', '2003-03-12', b'0', '0312312319', '$2a$10$dPuMfetDE2v3xHt1d47F6.FLUAVff0ZsCvfzM.YTWH6Cvzbi.hXeS', b'1', '319007', b'1', NULL, '2023-05-06', '2023-05-06');
INSERT INTO `users` VALUES (6, 'dev@gmail.com', NULL, 'gogg', NULL, b'0', NULL, '$2a$10$wfgchgVGa/W9hPXHPZtHhu9arZfRQalplLR04NQ.WbXZ.JxEyohwK', b'1', '917964', b'0', NULL, '2023-05-06', NULL);
INSERT INTO `users` VALUES (7, 'dinhnguen@gmail.com', NULL, 'Ng dinh nguyen', NULL, b'0', NULL, NULL, b'1', NULL, b'1', NULL, '2023-06-07', '2023-06-08');
INSERT INTO `users` VALUES (8, 'pho.02.112002@gmail.com', NULL, 'nguyen13', NULL, b'0', NULL, '$2a$10$Zg2K8CDj2zVGmxlQmOA6tOQCmwhWKsbbevZkEdDDGo8F9y710l.y6', b'1', '169047', b'1', 'LOCAL', '2024-06-22', NULL);
INSERT INTO `users` VALUES (9, 'essaymedicalnlu2024@gmail.com', 'Nguyễn Đình Nguyên', 'Essay Medical', '2002-06-25', b'0', '0935996512', NULL, b'1', NULL, b'1', 'GOOGLE', '2024-06-23', '2024-06-23');
